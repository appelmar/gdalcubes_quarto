...
Please use the [GitHub respository](https://github.com/appelmar/gdalcubes_R) and post issues if you have any questions, found bugs or would like to propose some new features.

...
Among others, the library provides data structures for *image collections*, *raster data cubes*, and implements the creation of data cubes and some functions on data cubes (see [Basic concepts](../concepts/index.qmd)).

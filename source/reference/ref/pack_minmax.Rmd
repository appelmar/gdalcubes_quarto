...
This function can be used to define packed exports in [`write_ncdf`](write_ncdf.Rmd)
and [`write_tif`](write_tif.Rmd). It will generate scale and offset values with maximum precision (unless simplify=TRUE).

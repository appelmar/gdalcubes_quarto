...
1. If all image files share the same bands / variables, the `bands` argument can be ignored (default NULL) can 
names of the bands can be specified using the `band_names` argument.

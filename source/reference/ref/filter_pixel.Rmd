...
gdalcubes uses and extends the [tinyexpr library](https://github.com/codeplea/tinyexpr) to evaluate expressions in C / C++, you can look at the [library documentation](https://github.com/codeplea/tinyexpr#functions-supported)
